        ...
        <div className="animate-fade-in text-black w-full min-w-0">
            <SectionBlock titleString="Prístupnosť (Accessibility)">
                ...
                <Ul>
                    ...
                    <li>
                        Názov rázcestníka musí byť implementovaný pomocou správnej úrovne nadpisu (zvyčajne <code className={codeClass}>&lt;h2&gt;</code>, <code className={codeClass}>&lt;h3&gt;</code> alebo <code className={codeClass}>&lt;h4&gt;</code>) v závislosti od hierarchie konkrétnej stránky. Asistenčné technológie to využívajú na rýchlu orientáciu.
                    </li>
                    <li>
                    ...
                    <li>
                        Ikonky určujúce tému rázcestníka, rovnako ako navigačná šípka, sú pre asistenčné technológie zväčša čisto dekoratívne. Musia byť skryté pred asistenčnými technológiami pomocou atribútu <code className={codeClass}>aria-hidden=true&quot;</code>.
                    </li>&quot;
                    <li>
                        Ak rázcestník vedie na externú stránku alebo otvára odkaz v novom okne, musí obsahovať skryté textové upozornenie pre asistenčné technológie (napríklad <code className={codeClass}>aria-label=&quot;Otvorí sa v novom okne&quot;</code>). Ak na to použijete špeciálnu ikonu externého odkazu, môžete upozornenie pridať priamo do nej.
                    </li>
                </Ul>
