...
const TabImplementacia = () => {
  ...
  return (
    <div className="animate-fade-in text-black w-full min-w-0">
      ...
      <SectionBlock titleString="Implementácia rozbaľovacieho poľa z ID-SK Frontend">
        <Text>
        ...
        <div className="mt-4 mb-8">
          ...
          <div className="space-y-8 mt-8">
            ...
            <div>
              ...
              <Text className="mb-4">
                Zo stránky dokumentácie stiahnite HTML kód komponentu <ExtLink href="https://komponenty.idsk3.gov.sk/components/select">rozbaľovací zoznam</ExtLink> a vložte ho do svojho HTML. Ak používate čisté HTML, musíte do značky <code className={codeClass}>&lt;div&gt;</code> pridať atribút <code className={codeClass}>id</code>. Tento atribút musí byť unikátny v rámci domény.
              </Text>
              <CodeBlock 
                language="html"
                codeString={`
        ...
        <div className="mt-12 mb-8">
          ...
          <Ol>
            ...
            <li className="mt-6">
              ...
              ID-SK Frontend komponenty s JavaScript správaním majú vo svojom markupe nastavený atribút <code className={codeClass}>data-module</code>. Pre import javascriptu rozbaľovacieho poľa, vložte do .js súboru:
              <CodeBlock 
                language="javascript"
                codeString={`
