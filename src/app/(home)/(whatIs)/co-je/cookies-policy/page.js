...
const SuboryCookies = () => {
  return (
    <div className="flex flex-col my-8 max-w-[1000px]">
      ...
      <header>
        <h1 className="text-5xl font-black text-black leading-[55.2px] max-md:mr-1 max-md:max-w-full max-md:text-4xl">Spracúvanie súborov cookies na webovej stránke idsk.gov.sk</h1>
      </header>
      <main id="main-content" role="main">
      <p className="mt-8 text-2xl tracking-wide leading-9 text-black max-md:max-w-full">Informácie pre dotknutú osobu pri získaní osobných údajov</p>
      <p className="mt-8 text-custom-19 leading-7 tracking-wide  text-black max-md:mr-1 max-md:max-w-full">Podľa čl. 13 a čl. 14 nariadenia Európskeho parlamentu a Rady (EÚ) č. 2016/679 z 27. apríla 2016 o ochrane fyzických osôb pri spracúvaní osobných údajov a o voľnom pohybe takých údajov, ktorým sa zrušuje smernica 95/46/ES (všeobecné nariadenie o ochrane údajov) (ďalej len „GDPR“) Ministerstvo investícií, regionálneho rozvoja a informatizácie Slovenskej republiky (ďalej ako „ministerstvo“, „MIRRI SR“ alebo „prevádzkovateľ”) ako subjekt, ktorý spracováva osobné údaje dotknutej osoby, poskytuje dotknutej osobe nasledovné informácie:</p>

      <h2 className="mt-8 text-4xl tracking-wide leading-7 text-black max-md:mr-1 max-md:max-w-full">1.	Identifikačné a kontaktné údaje prevádzkovateľa</h2>
