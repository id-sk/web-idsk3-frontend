    ...
    return (
        <div className="flex flex-col my-8 max-w-[1000px] px-4 sm:px-0">
            ...
            <div className="mt-8">
                ...
                <h2 className="mt-10 mb-4 text-xl sm:text-2xl font-bold tracking-wide text-black">
                ...
                <div className="space-y-6 text-sm sm:text-base md:text-lg tracking-wide leading-relaxed md:leading-8 text-black mb-8">
                    <p>
                ...
                <p className="text-sm sm:text-base md:text-lg tracking-wide leading-relaxed md:leading-8 text-black mb-2">
                    Táto časť obsahuje:
                </p>
                ...
                <ul className="list-disc pl-5 space-y-2 text-sm sm:text-base md:text-lg tracking-wide leading-relaxed md:leading-8 text-black mb-4">
                ...
                <ul className="list-disc pl-5 space-y-2 text-sm sm:text-base md:text-lg tracking-wide leading-relaxed md:leading-8 text-black mb-8">
                    <li>sprioritizovaný zoznam identifikovaných problémov použiteľnosti podľa frekvencie a závažnosti,</li>
                    <li>dokumentáciu meraných metrík pre kľúčové prípady použitia:
                        {/* Správne vnorený zoznam a, b, c */}
