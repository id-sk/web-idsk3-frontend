...
const MetodikaPage = () => {
    return (
        <div className="flex flex-col my-8 max-w-[1000px]">
            ...
            <p className="text-2xl leading-9 tracking-wide mb-16">
            ...
            <ul className='text-custom-19 leading-7 tracking-wide list-disc list-inside mb-4'>
                <li>Formatívne testovanie použiteľnosti prototypu je vykonané na vzorke aspoň 6 respondentov pre každú relevantnú cieľovú skupinu.</li>
                <p className="ml-6">Výstupom testovania je report, ktorý obsahuje:</p>
            ...
            <ul className="text-custom-19 leading-7 tracking-wide list-disc list-inside mb-4">
                ...
                <ul className="ml-7" type="a">
                <li>a. čas úlohy</li>
                </ul>
                <ul className="ml-7" type="b">
                <li>b. chybovosť úlohy</li>
                </ul>
                <ul className="ml-7" type="c">
                <li>c. efektivita úlohy</li>
                </ul>
