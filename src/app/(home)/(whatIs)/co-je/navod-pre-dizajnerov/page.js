    ...
    return (
        <div className="component-page">
            ...
            <PrimaryButton
                ...
                className='my-4 ml-1'
            />
            <iframe style={{ border: '1px solid rgba(0, 0, 0, 0.1)' }} width="800" height="450" src="https://embed.figma.com/file/1581301778555425083/hf_embed?community_viewer=true&embed_host=fastma&kind=file&page-selector=0&viewer=1" allowFullScreen title='Figma pre dizajnérov'>
            </iframe>
        </div>
    );
}
