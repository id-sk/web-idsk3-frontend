...
const CardExample = () => {
  return (
    <article className="flex flex-col gap-2.5 justify-center p-0.5 mt-8 max-w-full rounded-xl border-custom-orange border-solid border-[3px] w-[804px]">
      <div className="flex flex-wrap gap-8 p-5 w-full bg-white rounded-xl border border-solid border-neutral-300">
        ...
        <div className="flex flex-col flex-1 shrink justify-center self-start tracking-wide basis-0 min-w-[240px] max-md:max-w-full">
          <div className="flex flex-col w-full max-md:max-w-full">
            <h3 className="text-2xl font-bold text-my-blue underline max-md:max-w-full">
              Nadpis kartičky
            </h3>
