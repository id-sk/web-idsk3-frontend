...
const CheckboxExample = () => {
  return (
    <div className="flex flex-col gap-2.5 justify-center p-0.5 mt-8 max-w-full text-custom-19 leading-7 tracking-wide text-center text-black rounded-md border-amber-600 border-solid border-[3px] w-[200px]">
