...
const RadioExample = () => {
  return (
    <div className="flex gap-8 items-start self-start mt-8">
      <div className="flex flex-col gap-2.5 justify-center p-0.5 text-custom-19 tracking-wide leading-7 text-black rounded-md border-amber-600 border-solid border-[3px] w-[198px]">
