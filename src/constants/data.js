...
export const componentsData = [
  ...
  { href: "/komponenty/informacna-lista-oznamenie", src: "/images/komponenty-cards/info-lista-oznamenie.svg", title: "Informačný banner - oznámenie", description: "Prvok slúžiaci na zobrazenie permanentnej informácie pre používateľa.", alt: ""},
  { href: "/komponenty/informacna-lista-upozornenie", src: "/images/komponenty-cards/info-lista-upozornenie.svg", title: "Informačný banner - upozornenie", description: "Výrazný prvok, upozornenie použivateľa o podstatných/nových informáciach", alt: ""},
  ...
  { href: "komponenty/omrvinkova-navigacia", src: "/images/komponenty-cards/", title: "Omrvinková navigácia", description: "Navigačný prvok formou jednoduchej dlaždice , zloženej z nadpisu, popisu a oddeľovacej čiary.", alt: ""},
  ...
  { href: "/komponenty/razcestnik-horizontalny", src: commonSrc, title: "Horizontálny rázcestník", description: "Navigačný prvok formou jednoduchej dlaždice usporiadanej horizontálne", alt: ""},
  { href: "/komponenty/razcestnik-textovy", src: commonSrc, title: "Textový rázcestník", description: "Navigačný prvok formou jednoduchej dlaždice , zloženej z nadpisu, popisu a oddeľovacej čiary.", alt: ""},
  { href: "/komponenty/razcestnik-vertikalny", src: commonSrc, title: "Vertikálny rázcestník", description: "Navigačný prvok formou jednoduchej dlaždice usporiadanej vertikálne", alt: ""},
